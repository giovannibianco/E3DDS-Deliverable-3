...
The higher data levels (to level 3 or 4) are integrated summary or user-produced data.
...
The expected access mechanism to 
Authentication 
The strength of the 
authentication of users 
Reference mainly to the federated identity e.g. EGI Checkin. Others? EduGAIN federation?

For example the EGI Check-in service can be integrated 
Elixir AAI~\cite{elixir-aai}
